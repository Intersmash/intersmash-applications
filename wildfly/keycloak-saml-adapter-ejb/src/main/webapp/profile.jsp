...
<html>
    ...
    <body>
        <jsp:useBean id="controller" class="org.jboss.intersmash.applications.wildfly.keycloak.saml.adapter.Controller" scope="request"/>
            ...
            <div class="content">
                <div id="profile-content" class="message">
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="label">Username from EJB</td>
                            <td><span id="usernameEjb">${controller.getUsernameEjb()}</span></td>
                        </tr>
                    </table>
                </div>
            </div>
